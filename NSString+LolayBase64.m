...
@implementation NSString (LolayBase64)
...
- (NSData*) base64DataWithEncoding:(NSStringEncoding) encoding {
	const char * objPointer = [self cStringUsingEncoding:encoding];
...
+ (NSData*) base64DataWithString:(NSString*) base64String encoding:(NSStringEncoding) encoding {
	return [base64String base64DataWithEncoding:encoding];
}

- (NSData*) base64Data {
	return [self base64DataWithEncoding:NSUTF8StringEncoding];
}

+ (NSData*) base64DataWithString:(NSString*) base64String {
	return [base64String base64DataWithEncoding:NSUTF8StringEncoding];
}
